# devhub-terraform-azurerm-network
...
```hcl
module "network" {
  source = "git::https://github.com/CollinPoetoehena/devhub-terraform-azurerm-network.git?ref=1.0.0"
